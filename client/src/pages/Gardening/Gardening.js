...
class Gardening extends React.Component{
	...
	componentDidMount = () =>{
		...
		.then(res => {
			...
			const filtered = res.data.filter(post =>{return post.category === "gardening"})
		...
		return(
			<>
				...
				<Route  render ={(routerProps)=>
					...
					<Category handleGoback={this.handleGoback} categoryName={"Gardening"} data={this.state.userPosts}/>
