...
class General extends React.Component{
	...
	componentDidMount = () =>{
		...
		.then(res => {
			...
			const filtered = res.data.filter(post =>{return post.category === "general"})
		...
		return(
			<>
				...
				<Route  render ={(routerProps)=>
					...
					<Category handleGoback={this.handleGoback} categoryName={"General"} data={this.state.userPosts}/>
