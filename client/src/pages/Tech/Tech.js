...
class Tech extends React.Component{
	...
	componentDidMount = () =>{
		...
		.then(res => {
			...
			const filtered = res.data.filter(post =>{return post.category === "electronics"})
		...
		return(
			<>
				...
				<Route  render ={(routerProps)=>
					...
					<Category handleGoback={this.handleGoback} categoryName={"Electronics"} data={this.state.userPosts}/>
