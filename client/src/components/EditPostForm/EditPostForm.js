		...
		<section className='edit'>
			<form onSubmit={props.handleUpload} className='edit__container'>
				...
				<article className='edit__image'>
					...
					<input onChange={props.handleChangeImg} type='file' id='uploadImg' className='edit__upload' name='image' multiple={true}  /> {/* display None */}
				</article>
				<div className='edit__info-container'>

					<label className='edit__label'>Title</label>
					<input onChange={props.handleChange} className='edit__input' name='title' />

					<label className='edit__label'>Price</label>
					<input onChange={props.handleChange} className='edit__input' name='price' />
					...
					<input onChange={props.handleChange} className='edit__input' name='description' />

					<label className='edit__label'>Would You like your post on the hero banner? (10pts)</label>
					<div className='edit__checkbox-container'>
						<input onChange={props.handleChange} type='checkbox' disabled={props.currentUser.points>10?false:true} className='edit__input edit__input--checkbox' value={true}  name='premium' />
