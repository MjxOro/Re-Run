        ...
        <section className="sidebar">
          <nav className="sidebar__nav">
            <div className="sidebar__close-container">
              <h2 className="sidebar__greeting">
            ...
            <div className="sidebar__link-container">
              ...
              <div onClick={props.handleCheckPoints} className="sidebar__link">
                Points
              </div>
              <Link to="/mypostings" className="sidebar__link">
                My Postings
              </Link>
