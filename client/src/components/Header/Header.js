...
class Header extends react.Component {
  ...
  handleUpload = (e) => {
    ...
    axios
      .put(
        (process.env.REACT_APP_API_URL || "") + "/secure/upload/pfp/",
        formData,
        {
          headers: {
            authorization: `Bearer ${token}`,
    ...
    return (
      <>
        ...
        <PfpModal
          ...
          handleChangePfp={this.handleChangePfp}
        />
        {this.props.currentUser && (
          <header className="hd">
            <div className="hd__container">
              ...
              <nav className="hd__left-container">
                <nav className="hd__desktop-nav">
                  <Link to="/" className="hd__link">
                    Home
                  </Link>
                  <Link to="/mypostings" className="hd__link">
                    My Postings
                  </Link>
                  <div className="hd__link" onClick={this.handleCheckPoints}>
                    Points
                  </div>
                </nav>
                <Link to="/add/posts">
                ...
                <div className="hd__profile-tab">
                  <img
                    ...
                    className="hd__profile"
                    onClick={this.handleModalShow}
                  />
                  {!this.state.showSidebar ? (
                    <div
                      onClick={this.handleSidebar}
                      className="hd__btn-container"
                    >
                    ...
                    <div
                      onClick={this.handleSidebar}
                      className="hd__btn-container hd__btn-container--open"
                    >
            ...
            <Sidebar
              randomCat={this.randomCategory}
              handleCheckPoints={this.handleCheckPoints}
              handleLogout={this.handleLogout}
              currentUser={this.props.currentUser}
              close={this.handleSidebar}
              blnClose={this.state.showSidebar}
            />
          </header>
        )}
      </>
