...
const LoginForm = (props) => {
  ...
  function random() {
    switch (props.random) {
      ...
      case 2:
        return (
          <figure className="login__art-container login__art-container--img1" />
        );
        break;
      case 3:
        return (
          <figure className="login__art-container login__art-container--img2" />
        );
        break;
      default:
        return <figure className="login__art-container" />;
    ...
    <section className="login">
      ...
      >
        <main className="login__left">
          ...
          <div className="login__Oauth"></div>
          <label className="login__label">Email</label>
          <input
            onChange={props.handleChange}
            name="email"
            className={
              props.error.email || props.error.valid
          ...
          <input
            ...
            type="password"
            className={
              props.error.password || props.error.valid
                ? "login__input login__input--error"
                : "login__input"
            }
