		...
		<section className='add'>
			<form onSubmit={props.handleUpload} className='add__container'>
				<article className='add__image'>
					...
					<input onChange={props.handleChangeImg} type='file' id='uploadImg' className='add__upload' name='image' multiple={true}  /> {/* display None */}
				</article>
				<div className='add__info-container'>
					...
					<div className='add__checkbox-container'>
						<input onChange={props.handleChange} type='checkbox' disabled={true} className='add__input add__input--checkbox'  name='premium' />
