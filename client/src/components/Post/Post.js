...
const Post = (props) => {
  ...
  const filteredUser = props.allUsers.find((user) => {
    return user._id === props.data.userId;
  });
  const createChat = () => {
    const formData = {
        ...
        >
          <motion.div className="post__main-container">
            <div className="post__top">
              ...
              />
              <motion.div
                className="post__text-container"
              ...
              >
                ...
                <div onClick={createChat} className="post__userChat">
                  ...
                  />
                  <p className="post__chat-text">
                    {"Interested? Message: " + filteredUser.username}
                  </p>
                </div>
          ...
          <article className="post__map-api"></article>
        </motion.section>
      )}
    </>
  );
